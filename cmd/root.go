...
var rootCmd = &cobra.Command{
	Use:   "fairyringclient",
	Short: "An executable for getting, deriving and submitting key share for FairyRing",
	Long:  `FairyRing Client is a CLI library for submitting key share to FairyRing automatically`,
}
